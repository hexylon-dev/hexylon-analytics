...
const OurServices = () => {
  ...
  return (
    <div className="max-w-[full] mx-auto">
      <div className="sticky top-[75px] z-50 shadow-md p-4">
      ...
      <div className="flex mt-16">
        ...
        <div className="max-w-[400px] border border-[red] p-2">
        ...
        <div
          ...
          className="flex-1 h-screen overflow-y-scroll p-5 bg-transparent border border-[red] scrollbar-hidden"
        >
...
//   return (
//     <div className="flex flex-col  w-[800px] bg-[#ffffff] shadow-xl">
//       <figure className="flex justify-center items-center ">
//         <ServiceCardPredictiveAnalytics />
//       </figure>
//       {/**/}
