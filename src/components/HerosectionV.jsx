...
export default function Component({ handleNavigateToContactPage }) {
  ...
  useEffect(() => {
    ...
    const assignHexagonPositions = () => {
      ...
      for (let i = 0; i < hexagonPoints.length; i++) {
        ...
        for (
          let j = 0;
          j < particlesPerSide && particleIndex < particles.length;
          j++
        ) {
          ...
          if (i !== j) {
            ...
            if (distance < connectionDistance) {
              ...
              ctx.strokeStyle = `rgba(255, 102, 0, ${
                0.3 - (distance / connectionDistance) * 0.2
              })`;
              ctx.lineWidth = 0.5;
              ctx.stroke();
            }
  ...
  const features = [
    {
      ...
      description:
        "Customized AI solutions designed specifically to address your business challenges and objectives, ensuring optimal performance and measurable results. We create personalized models that align with your goals, driving innovation and efficiency.",
    },
    {
      icon: Lightbulb,
      title: "Expert Guidance & Support",
      description:
        "Work with industry-leading consultants who bring deep expertise and experience, guiding you through every stage of your AI transformation journey. From initial strategy sessions to implementation and scaling, we provide continuous support to ensure success.",
    },
    {
      icon: Users,
      title: "Complete AI Lifecycle Support",
      description:
        "Receive complete support from the initial consultation to deployment and beyond. Our end-to-end services guarantee that your AI solutions are seamlessly integrated, continuously optimized, and evolve with your business needs, ensuring sustained growth and value.",
    },
  ];
  ...
  return (
    <div ref={containerRef} className="bg-black">
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          >
            ...
            should be the technology that drives it. We specialize in creating
            AI solutions tailored specifically to your company's processes and
            workflow.
          </motion.p>
      ...
      <div
        id="why-choose-us"
        className="relative z-10 min-h-screen bg-t8ransparent max-w-7xl mx-auto py-12 sm:py-20 md-8 px-4 flex flex-col"
      >
        <motion.div
          initial={{ opacity: 0, y: 20 }}
