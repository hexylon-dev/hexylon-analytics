...
export function PageTitle({ title, subtitle }) {
  return (
    <div className="text-center mb-16 sm:mb-20 lg:mb-24 relative group perspective">
      ...
      <h2 className="text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-200 to-white mb-6 sm:mb-8 lg:mb-10 relative tracking-tight">
        {title}
