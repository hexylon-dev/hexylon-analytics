...
export const resources = [
    {
        ...
        <div>
          ...
          <h2 class="text-2xl font-bold mb-4 text-[#ff6600]">The Current State of AI in Healthcare</h2>
          <p class="mb-6">
          ...
          <h2 class="text-2xl font-bold mb-4 text-[#ff6600]">Key Areas Where AI is Making an Impact</h2>
        
          <h3 class="text-xl font-semibold mb-2">1. Predictive Diagnostics and Early Detection</h3>
          <p class="mb-6">
            One of the most transformative benefits of AI lies in AI-driven diagnostics. By analyzing patient histories, genetic factors, and environmental influences, AI can flag early indicators of conditions like cancer, diabetes, and cardiovascular diseases.
          </p>
        
          <h3 class="text-xl font-semibold mb-2">2. Personalized Treatment Plans</h3>
          <p class="mb-6">
            AI fosters AI-powered patient care by tailoring treatment regimens to individual patients. Instead of a one-size-fits-all approach, doctors can select therapies based on genetic makeup, lifestyle, and past medical records.
          </p>
        
          <h3 class="text-xl font-semibold mb-2">3. Operational Efficiency and Cost Reduction</h3>
          <p class="mb-6">
            Beyond the clinical sphere, AI in healthcare optimizes administrative tasks, workforce management, and supply chain logistics. Automated appointment scheduling reduces no-shows, while predictive analytics help maintain optimal inventory levels.
          </p>
        
          <h2 class="text-2xl font-bold mb-4 text-[#ff6600]">Why Choose Hexylon for AI in Healthcare?</h2>
          <ul class="list-disc list-inside mb-6">
            <li>Comprehensive Tools: Full suite of healthcare AI solutions</li>
            <li>Scalability and Security: Secure handling of patient data</li>
            <li>Dedicated Support: Expert guidance for maximizing platform value</li>
          </ul>
        
          <h2 class="text-2xl font-bold mb-4 text-[#ff6600]">Conclusion</h2>
          <p>
