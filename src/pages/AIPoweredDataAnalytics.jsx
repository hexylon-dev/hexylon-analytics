...
export const AIPoweredDataAnalytics = () => {
  ...
  return (
    <div className="relative  min-h-screen overflow-hidden">
      <Helmet>
        <title>AI Data Analytics Solutions | Hexylon Analytics</title>
        <meta
          name="description"
          content="Boost efficiency & decision making with AI driven analytics. Automate data processing, forecast trends & optimize operations with Hexylon Analytics."
        />
        <meta
          name="keywords"
          content="AI data analytics, predictive analytics, machine learning insights, business intelligence, real-time data analysis, automated reporting, AI-driven decisions, Hexylon Analytics"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "DataAnalyticsService",
            "name": "AI-Powered Business Intelligence Solutions",
            "description":
              "Transform raw data into actionable insights with our enterprise-grade predictive analytics and real-time decision-making platforms",
            "provider": {
              "@type": "DataScienceCompany",
              "name": "Hexylon Analytics",
              "awards": "Top 10 AI Analytics Providers 2024"
            },
            "serviceOutput": {
              "@type": "DataFeed",
            ...
            "analyticsTechniques": {
              ...
              machineLearningAlgorithms: ["XGBoost", "Prophet", "ARIMA"]
            },
            "businessImpact": {
              efficiencyGains: "40-75% faster insights",
              costReduction: "60% lower than traditional BI",
            ...
            "useCases": [
              {
                ...
                "industry": "E-Commerce",
                "benefit": "27% retention improvement"
              },
              {
                "@type": "AnalyticsUseCase",
                "name": "Inventory Optimization",
                "industry": "Manufacturing",
                "benefit": "35% waste reduction"
              }
            ]
          })}
        </script>
