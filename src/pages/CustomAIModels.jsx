...
export const CustomAIModels = () => {
  ...
  return (
    <div className="relative  min-h-screen overflow-hidden">
      <Helmet>
        <title>Custom AI Model Development | Hexylon Analytics</title>
        <meta
          name="description"
          content="Boost efficiency & decision-making with tailor-made AI models from Hexylon Analytics. From design to deployment, we deliver scalable, data-driven solutions."
        />
        <meta
          name="keywords"
          content="custom AI models, AI model development, machine learning solutions, predictive analytics, business automation, Hexylon Analytics"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "ProfessionalService",
            "name": "Tailored AI Model Development",
            "description":
              "Enterprise-grade custom AI solutions designed for your unique business needs - from predictive analytics to operational automation",
            "provider": {
              "@type": "Organization",
            ...
            "offers": {
              ...
              "itemOffered": {
                "@type": "Service",
                "name": "Custom AI Model Creation",
                "description":
                  "Machine learning models specifically engineered for your data and business objectives",
                "serviceOutput": {
              ...
              "itemListElement": [
                {
                  ...
                  "itemOffered": {
                    ...
                    "description":
                      "Custom algorithms for forecasting trends and behaviors"
                  }
                },
                {
                  "@type": "Offer",
                  "itemOffered": {
                    ...
                    "description": "Tailored image recognition solutions"
                  }
                }
              ]
            }
