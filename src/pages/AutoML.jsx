...
export const AutoML = () => {
  ...
  return (
    <div className="relative  min-h-screen overflow-hidden">
      <Helmet>
        <title>AutoML Solutions | Automated Machine Learning for Business</title>
        <meta
          name="description"
          content="Hexylon Analytics delivers AutoML solutions to automate machine learning workflows—from data prep to deployment. Accelerate AI adoption with no-code ML for faster insights."
        />
        <meta
          name="keywords"
          content="AutoML solutions, automated machine learning, no-code AI, hyperparameter tuning, Google AutoML, Azure AutoML, predictive modeling, Hexylon Analytics"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description":
              "End-to-end automated machine learning for data preparation, model training, and deployment",
            "applicationCategory": "BusinessApplication",
            "featureList":
              "Hyperparameter tuning, No-code interface, Model explainability",
