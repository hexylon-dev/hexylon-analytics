...
export const ComputerVision = () => {
  ...
  return (
    <div className="relative  min-h-screen overflow-hidden">
      <Helmet>
        <title>AI-Powered Computer Vision Solutions | Hexylon Analytics</title>
        <meta
          name="description"
          content="Hexylon Analytics delivers cutting-edge AI-driven computer vision solutions for automation, security, healthcare & more. Transform visual data into actionable insights."
        />
        <meta
          name="keywords"
          content="computer vision AI, AI-driven vision, object detection, facial recognition, real-time surveillance, healthcare imaging, Hexylon Analytics"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description":
              "AI-powered computer vision solutions for object detection, facial recognition, and real-time surveillance across industries",
            "hasOfferCatalog": {
              "@type": "OfferCatalog",
              ...
              "itemListElement": [
                {
                  ...
                  "itemOffered": {
                    ...
                    "description":
                      "Automated defect detection using CNN models with 99.2% accuracy",
                    "serviceOutput": "Real-time anomaly alerts",
                ...
                },
                {
                  ...
                  "itemOffered": {
                    "@type": "Service",
                    "name": "Healthcare Imaging Analysis",
                    "description":
                      "AI diagnostics for X-rays/MRIs with FDA-compliant algorithms",
                    "serviceOutput": "Structured diagnostic reports",
                    "areaServed": ["IN", "US", "UAE"]
                  }
                },
                {
                  ...
                  "itemOffered": {
                    ...
                    "description":
                      "Real-time threat detection with facial recognition and behavior analysis",
                    "serviceOutput": "Security incident logs",
                    "areaServed": ["IN", "US", "UAE"]
                  }
                }
              ]
            ...
            "termsOfService": "https://hexylonanalytics.com/terms",
            "feature": [
