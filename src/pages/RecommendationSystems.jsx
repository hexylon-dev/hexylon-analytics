...
export const RecommendationSystems = () => {
  ...
  return (
    <div className="relative  min-h-screen overflow-hidden">
      <Helmet>
        <title>E-commerce AI Recommendations | Boost Conversions</title>
        <meta
          name="description"
          content="Increase conversions by 30% with AI-powered product recommendations. Tailored suggestions for e-commerce, apps & content platforms."
        />
        <meta
          name="keywords"
          content="AI recommendation engine, personalized recommendations, collaborative filtering, e-commerce AI, product recommendation system, predictive suggestions, Hexylon Analytics"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description":
              "Enterprise-grade recommendation system using collaborative filtering and predictive analytics",
