...
export const AIforProcessAutomation = () => {
  ...
  return (
    <div className="relative  min-h-screen overflow-hidden">
      <Helmet>
        <title>AI Process Automation Solutions | Hexylon Analytics</title>
        <meta
          name="description"
          content="Revolutionize operations with AI automation: streamline workflows, predict bottlenecks & slash costs. Partner with Hexylon Analytics for tailored AI solutions."
        />
        <meta
          name="keywords"
          content="AI process automation, workflow automation, AI-powered efficiency, reduce operational costs, automate repetitive tasks, predictive workflow analytics, Hexylon Analytics"
        />
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description":
              "Automate repetitive tasks, optimize workflows & reduce costs with AI-driven solutions.",
            "provider": {
              "@type": "Organization",
