  ...
  return (
    <>
      <div className="bg-black relative ">
        <Helmet>
          <title>Custom AI Solutions | Business Automation Experts</title>
          <meta
            name="description"
            content="Hexylon Analytics: Ahmedabad's top AI development firm. Build custom machine learning models, automation tools & real-time dashboards to transform your business operations."
          />
          <meta
            name="keywords"
            content="AI development company Ahmedabad, custom machine learning solutions, business automation AI, real-time analytics dashboard, HR automation tools, Hexylon Analytics"
          />
          <script type="application/ld+json">
            {JSON.stringify({
              ...
              "image": "https://hexylonanalytics.com/logo.png",
              "@id": "https://hexylonanalytics.com",
              "url": "https://hexylonanalytics.com",
              "telephone": "+917990821728",
              "address": {
                "@type": "PostalAddress",
